...
//  TechniApp
//
//  Created by Gаггу-Guииz  on 04/04/2017.
//  Copyright © 2017 COFELY_Technibook. All rights reserved.
//

import UIKit

class Missionweb: UIViewController,UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let url = URL(string: "https://www.m11.alteva.eu/wd170awp/wd170awp.exe/connect/Mission_Web_1774?base=coveagtpe") {
